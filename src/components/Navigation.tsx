          ...
          <div className="hidden md:block">
            <div className="flex items-center space-x-1">
              ...
              <motion.a
                ...
                download
                className="ml-4 px-6 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg font-medium hover:shadow-lg hover:shadow-blue-500/50 transition-all duration-300"
              >
                Download CV
              </motion.a>
            </div>
          ...
          >
            <div className="px-4 pt-2 pb-6 space-y-1">
              ...
              <a
                href="/resume/JuanAndresGarcia_CV.pdf"
                download
                className="block w-full text-center px-4 py-3 mt-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg font-medium hover:shadow-lg hover:shadow-blue-500/50 transition-all duration-300"
              >
                Download CV
              </a>
            </div>
